...
for FOLDER in ${DAVIS_FOLDERS[@]}; do
    ...
    #srun bash -c "ls /scratch0/mgwillia/DAVIS_ANNOS/$FOLDER;"
    ...
    #srun bash -c "ls /scratch0/mgwillia/DAVIS_MASKS/$FOLDER;"
