...
for FOLDER in ${DAVIS_FOLDERS[@]}; do
    ...
    srun bash -c "python scripts/preprocess_mask.py --annotation-path /scratch0/mgwillia/DAVIS_ANNOS/$FOLDER --mask-path /scratch0/mgwillia/DAVIS_MASKS/${FOLDER}_fixed --generate-fix-mask;"
    srun bash -c "python train.py --log-dir logs/$FOLDER --dir-video /scratch0/mgwillia/DAVIS/$FOLDER --dir-mask /scratch0/mgwillia/DAVIS_MASKS/${FOLDER}_fixed;"
